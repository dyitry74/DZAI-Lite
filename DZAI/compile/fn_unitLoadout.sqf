/*
	...
	Last updated: 12:39 PM 8/3/2013
*/
	...
	if (_weapongrade in DZAI_weaponGrades) then {
		...
		//Add weapon, ammunition
		_magazine = getArray (configFile >> "CfgWeapons" >> _weapon >> "magazines") select 0;
		_unit addMagazine _magazine;
		_unit addWeapon _weapon;
		_unit selectWeapon _weapon;
		if (DZAI_debugLevel > 1) then {diag_log format ["DZAI Extended Debug: Created weapon %1 for AI with weapongrade %2. (fn_unitSelectWeapon)",_weapon,_weapongrade];};
