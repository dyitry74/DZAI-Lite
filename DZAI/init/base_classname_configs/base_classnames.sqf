...
*/
	...
	if !(DZAI_dynamicWeaponList) then {
		...
		DZAI_Rifles3 = ["FN_FAL","bizon_silenced","M14_EP1","FN_FAL_ANPVS4","M107_DZ","BAF_AS50_scoped","Mk_48_DZ","M249_DZ","BAF_L85A2_RIS_SUSAT","DMR","G36C","G36C_camo","G36A_camo","G36K_camo"];
