/*
	...
	Description: Periodically reports current statistics tracked by DZAI Lite.
...
while {true} do {
	...
	if (DZAI_dynAISpawns || DZAI_aiHeliPatrols) then {diag_log format ["DZAI Monitor :: Dynamic Spawns - %1/%2 (active/total) dynamic triggers. %3/%4 (cur/max) active helicopter patrols.",DZAI_actDynTrigs,DZAI_curDynTrigs,DZAI_curHeliPatrols,DZAI_maxHeliPatrols];};
